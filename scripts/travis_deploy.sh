...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "ChristianLieven/trial1" ]]; then
...
echo "Your new report will be visible at https://ChristianLieven.github.io/trial1 in a moment."
